...
function useMousePositionRef(containerRef: MutableRefObject<HTMLElement | null>) {
  const positionRef = useRef({ x: -1000, y: -1000 }); // Default off-screen
...
const VariableProximity = forwardRef<HTMLSpanElement, VariableProximityProps>((props, ref) => {
  ...
  return (
    <span
      ...
      style={{
        display: 'inline',
        fontFamily: "'Satoshi-Extrabold', sans-serif", // Using our custom font
        ...style
      }}
      className={className}
      {...restProps}
          ...
          {word.split('').map(letter => {
            ...
            return (
              <motion.span
                ...
                className="text-muted-foreground hover:text-foreground" // Adds a subtle color pop on hover too
                aria-hidden="true"
              >
                {letter}
              </motion.span>
